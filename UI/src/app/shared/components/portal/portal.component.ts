...
import { GarbageAdminConsentService } from '@app/features/admin/services/garbage-admin-consent.service';
import { GarbageAdminConsentModalComponent } from '@app/shared/components/garbage-admin-consent-modal/garbage-admin-consent-modal.component';
