...
import { Address, formatLocalizedAddress } from '@app/shared/models/address';
import { Pager, PaginatedResult } from '@app/shared/models/result';
import { GarbageAdminOrdersService } from '@app/features/admin/services/garbage-admin-orders.service';
...
@Component({
  ...
  styleUrls: ['./garbage-admin-orders-assigned.component.scss']
})
