...
// Services
import { GarbageOrderService, USER_ORDERS_PAGE_SIZE } from '@app/features/orders/services/garbage-order.service';
...
// Models
import { GarbageOrderDetailsDto, GarbageOrderDto, GarbageOrderStatus, GarbageOrderUserDto, PickupOption } from '@app/shared/models/garbage-orders';

// Pipes
import { TranslatePipe } from '@app/shared/pipes/translate.pipe';

// Constants
import { getGarbageOrderStatusClass, getGarbageOrderStatusTranslationKey } from '../../constants/order.constants';
...
export class OrderDetailsComponent {
  ...
  statusClass(status: GarbageOrderStatus): string {
    return getGarbageOrderStatusClass(status);
  }

  statusTranslationKey(status: GarbageOrderStatus): string {
    return getGarbageOrderStatusTranslationKey(status);
  }
