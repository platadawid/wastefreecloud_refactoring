...
import { GarbageGroup, GarbageGroupInfo, RegisterGarbageGroupRequest, GarbageGroupInvitation, UpdateGarbageGroupRequest, GarbageGroupWithUsers } from '@app/shared/models/garbage-groups';
