...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WasteFree.Domain.Entities.GarbageAdminConsent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("GarbageAdminConsents");
                });
            ...
            modelBuilder.Entity("WasteFree.Domain.Entities.GarbageOrder", b =>
                {
                    ...
                    b.Property<decimal?>("AdditionalUtilizationFeeAmount")
                        .HasColumnType("TEXT");

                    b.Property<Guid?>("AssignedGarbageAdminId")
                        .HasColumnType("TEXT");

                    b.Property<bool>("CollectingService")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("GarbageOrderStatus")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<decimal>("PrepaidUtilizationFeeAmount")
                        .HasColumnType("TEXT");

                    b.Property<decimal?>("UtilizationFeeAmount")
                        .HasColumnType("TEXT");

                    b.Property<DateTime?>("UtilizationFeeSubmittedDateUtc")
                        .HasColumnType("TEXT");

                    b.Property<string>("UtilizationProofBlobName")
                        .HasColumnType("TEXT");

                    b.HasKey("Id");

                    b.HasIndex("AssignedGarbageAdminId");

                    b.HasIndex("GarbageGroupId");

                    b.ToTable("GarbageOrders");
                });

            modelBuilder.Entity("WasteFree.Domain.Entities.GarbageOrderUsers", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");

                    b.Property<decimal>("AdditionalUtilizationFeeShareAmount")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<Guid>("GarbageOrderId")
                        .HasColumnType("TEXT");

                    b.Property<bool>("HasAcceptedPayment")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("HasPaidAdditionalUtilizationFee")
                        .HasColumnType("INTEGER")
                    ...
                    b.HasIndex("GarbageOrderId");

                    b.HasIndex("UserId");

                    b.ToTable("GarbageOrderUsers");
                });
            ...
            modelBuilder.Entity("WasteFree.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("ConsentsAgreed")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("WasteFree.Domain.Entities.GarbageGroup", b =>
                {
                    b.OwnsOne("WasteFree.Domain.Models.Address", "Address", b1 =>
                        {
                            b1.Property<Guid>("GarbageGroupId")
                                .HasColumnType("TEXT");
                            ...
                            b1.HasKey("GarbageGroupId");

                            b1.ToTable("GarbageGroups");
            ...
            modelBuilder.Entity("WasteFree.Domain.Entities.GarbageOrder", b =>
                {
                    b.HasOne("WasteFree.Domain.Entities.User", "AssignedGarbageAdmin")
                        .WithMany()
                        .HasForeignKey("AssignedGarbageAdminId")
                    ...
                    b.Navigation("AssignedGarbageAdmin");
            ...
            modelBuilder.Entity("WasteFree.Domain.Entities.GarbageOrderUsers", b =>
                {
                    b.HasOne("WasteFree.Domain.Entities.GarbageOrder", "GarbageOrder")
                        .WithMany("GarbageOrderUsers")
                        .HasForeignKey("GarbageOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WasteFree.Domain.Entities.GarbageOrder", b =>
                {
                    b.Navigation("GarbageOrderUsers");
                });
